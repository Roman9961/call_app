 ...
 */
final class Version20190426112720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD parent_id INT DEFAULT NULL, ADD account_code INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP parent_id, DROP account_code');
    }
}
